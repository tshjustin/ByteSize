...
//     paper.categories?.some(category => selectedTags.includes(category))
//   )

//   const hotPapers = filteredPapers.filter((paper) => paper.isHot).slice(0, 3)
//   const recentPapers = filteredPapers.filter((paper) => !paper.isHot)
//     .sort((a, b) => new Date(b.date).getTime() - new Date(a.date).getTime())
